              ...
              {cart.cartItems.map((product, index) => (
                <TableRow key={index} sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                  ...
                  <TableCell>
                    ...
                    <Button disabled={product.quantity <= 1} onClick={() => decQty(product)} className="qty_btn">
                      -
                    </Button>
                    <input type="text" className="input_qty" value={product.quantity} onChange={(e) => updateQty(id, product, e)} size="3" />
